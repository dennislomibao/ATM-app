/* Hey guys this another bank system I got from chegg,
if you want save it to your own workspace or something
as I might delete later in case Rohan sees. */

#include <stdio.h>

#include <conio.h>      /* a bit unfortunate that they used this library */
